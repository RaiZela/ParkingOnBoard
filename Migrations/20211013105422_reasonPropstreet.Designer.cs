...
namespace ParkingOnBoard.Migrations
{
    ...
    [Migration("20211013105422_reasonPropstreet")]
    partial class reasonPropstreet
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingOnBoard.MODELS.ReasonsForClosing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ParkingOnBoard.MODELS.Street", b =>
                {
                    ...
                    b.HasOne("ParkingOnBoard.MODELS.ReasonsForClosing", "Reason")
                        .WithMany()
