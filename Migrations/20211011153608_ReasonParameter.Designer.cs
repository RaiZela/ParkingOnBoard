...
namespace ParkingOnBoard.Migrations
{
    ...
    [Migration("20211011153608_ReasonParameter")]
    partial class ReasonParameter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingOnBoard.MODELS.ReasonForClosing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ParkingOnBoard.MODELS.State", b =>
                {
                    b.HasOne("ParkingOnBoard.MODELS.ReasonForClosing", "Reason")
                        .WithMany()
